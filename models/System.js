...
module.exports = (sequelize) => {
  return sequelize.define('System', {
    ...
    sign_off_site_inspection_date: DataTypes.DATE,
    sign_off_site_inspection_user_id: DataTypes.INTEGER,
    sign_off_installation_date: DataTypes.DATE,
    sign_off_installation_user_id: DataTypes.INTEGER,
    consumer_id: DataTypes.INTEGER,
    consumer_type: DataTypes.TEXT,
    system_owner_id: DataTypes.INTEGER,
    system_owner_type: DataTypes.TEXT,
    roof_owner_id: DataTypes.INTEGER,
    roof_owner_type: DataTypes.TEXT,
    user_id_sales_person: DataTypes.INTEGER,
